...
@interface MenuSelect ()<UITableViewDelegate,UITableViewDataSource,UIGestureRecognizerDelegate>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.title.text =  [self.array objectAtIndex:indexPath.row][@"name"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    self.hidden = YES;
        ...
        //回传信息
    BLOCK_EXEC(self.chooseMenuSelect,indexPath.row,[self.array objectAtIndex:indexPath.row]);
