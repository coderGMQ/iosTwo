...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    switch (self.index) {
        ...
        case 0:{
            ...
            //名称赋值
            [self.info setObject:model.areaname forKey:@"province"];
            
            //删除部分数据
            [self.info removeObjectsForKeys:@[@"city",@"cityId",@"region",@"regionId",@"street",@"streetId"]];
        }
            break;
        case 1:{
            ...
            //名称赋值
            [self.info setObject:model.areaname forKey:@"city"];
            //删除部分数据
            [self.info removeObjectsForKeys:@[@"region",@"regionId",@"street",@"streetId"]];
        }
            break;
        case 2:{
            //存储区级数据ID
            ...
            //名称赋值
            [self.info setObject:model.areaname forKey:@"region"];
            
            //删除部分数据
            [self.info removeObjectsForKeys:@[@"street",@"streetId"]];
        }
            break;
        case 3:{
            //存储区级数据ID
            ...
            //名称赋值
            [self.info setObject:model.areaname forKey:@"street"];
        }
            break;
    }
...
- (IBAction)sureChoose:(UIButton *)sender {
    ...
    if (self.chooseOverBlock){
        
        self.chooseOverBlock(self.info);
    }
